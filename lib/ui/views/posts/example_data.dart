...
List<Reaction> flagsReactions = [
  Reaction(
    id: 1,
    previewIcon: _buildPreviewIcon('assets/images/like.gif', 'Like'),
    icon: _buildIcon('assets/images/like.png'),
  ),
  Reaction(
    id: 2,
    previewIcon: _buildPreviewIcon('assets/images/haha.gif', 'HaHa'),
    icon: _buildIcon('assets/images/haha.png'),
  ),
  Reaction(
    id: 3,
    previewIcon: _buildPreviewIcon('assets/images/wow.gif', 'Wow'),
    icon: _buildIcon('assets/images/wow.png'),
  ),
  Reaction(
    id: 4,
    previewIcon: _buildPreviewIcon('assets/images/love.gif', 'Love'),
    icon: _buildIcon('assets/images/love.png'),
  ),
  Reaction(
    id: 5,
    previewIcon: _buildPreviewIcon('assets/images/sad.gif', 'Sad'),
    icon: _buildIcon('assets/images/sad.png'),
  ),
];
